...
<template>
  <div class="min-h-screen bg-bg-primary text-text-primary flex flex-col font-sans selection:bg-primary-subtle selection:text-primary">
    ...
    <!-- Hero Section -->
    <section class="relative pt-6 pb-8 md:pt-10 md:pb-12 px-4 sm:px-6 overflow-hidden border-b border-border bg-linear-to-b from-surface to-bg-primary">
      ...
      <div class="max-w-5xl mx-auto text-center space-y-4 relative z-10">
        ...
        <!-- Main Title -->
        <h1 class="font-serif font-bold text-3xl sm:text-4xl md:text-5xl text-text-primary tracking-tight leading-[1.15] max-w-4xl mx-auto">
        ...
        <!-- Subtitle -->
        <p class="text-sm sm:text-base text-text-secondary max-w-2xl mx-auto leading-relaxed font-medium">
        ...
        <div class="pt-3 flex flex-wrap items-center justify-center gap-3">
          <button
            ...
            class="px-5 py-2.5 rounded-xl bg-primary hover:bg-primary-hover text-on-primary font-bold text-sm shadow-lg hover:shadow-xl transition-all flex items-center gap-2 active:scale-95">
          ...
          <router-link
            to="/mapa"
            class="px-5 py-2.5 rounded-xl bg-surface hover:bg-bg-secondary border border-border text-text-primary font-bold text-sm transition-all flex items-center gap-2 active:scale-95 shadow-xs">
        ...
        <!-- Quick Stats Banner -->
        <div class="pt-4 grid grid-cols-2 md:grid-cols-4 gap-3 max-w-3xl mx-auto">
          <div class="p-3.5 rounded-2xl bg-surface/80 border border-border text-center shadow-2xs">
            <div class="font-serif font-bold text-xl text-primary">
          ...
          <div class="p-3.5 rounded-2xl bg-surface/80 border border-border text-center shadow-2xs">
            <div class="font-serif font-bold text-xl text-highlight-strong">
          ...
          <div class="p-3.5 rounded-2xl bg-surface/80 border border-border text-center shadow-2xs">
            <div class="font-serif font-bold text-xl text-text-primary">100%</div>
            <div class="text-[11px] font-semibold text-text-tertiary uppercase tracking-wider">Your Own Taste</div>
          </div>

          <div class="p-3.5 rounded-2xl bg-surface/80 border border-border text-center shadow-2xs">
            <div class="font-serif font-bold text-xl text-primary">1v1</div>
    ...
    <section class="py-8 px-4 sm:px-6 max-w-6xl mx-auto w-full space-y-6">
      <div class="text-center space-y-1.5">
        <h2 class="font-serif font-bold text-2xl sm:text-3xl text-text-primary">Everything you need for your foodie life</h2>
        <p class="text-xs text-text-tertiary max-w-xl mx-auto font-medium">Tools designed for foodies who value honesty and great meals.</p>
      </div>

      <!-- Grid of 4 Core Pillars -->
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        <!-- Feature 1: Duelo de Sabor -->
        <div class="p-4 rounded-2xl bg-surface border border-border hover:border-primary/40 transition-all shadow-sm space-y-2.5 group">
          <div class="p-2.5 rounded-xl bg-primary-subtle text-primary w-fit">
            <Trophy class="w-6 h-6" />
          </div>
          <div class="space-y-1">
            <h3 class="font-serif font-bold text-lg text-text-primary group-hover:text-primary transition-colors">1v1 Duel Ranking</h3>
        ...
        <div class="p-4 rounded-2xl bg-surface border border-border hover:border-primary/40 transition-all shadow-sm space-y-2.5 group">
          ...
          <div class="space-y-1">
            <h3 class="font-serif font-bold text-lg text-text-primary group-hover:text-primary transition-colors">Geolocated Map & Filters</h3>
            <p class="text-xs text-text-secondary leading-relaxed">
        ...
        <div class="p-4 rounded-2xl bg-surface border border-border hover:border-primary/40 transition-all shadow-sm space-y-2.5 group">
          <div class="p-2.5 rounded-xl bg-(--color-highlight-subtle) text-highlight-strong w-fit">
            <Dices class="w-6 h-6" />
          </div>
          <div class="space-y-1">
            <h3 class="font-serif font-bold text-lg text-text-primary group-hover:text-primary transition-colors">"Where to Eat Today?" Decider</h3>
            <p class="text-xs text-text-secondary leading-relaxed">
        ...
        <div class="p-4 rounded-2xl bg-surface border border-border hover:border-primary/40 transition-all shadow-sm space-y-2.5 group">
          ...
          <div class="space-y-1">
            <h3 class="font-serif font-bold text-lg text-text-primary group-hover:text-primary transition-colors">Want-to-Try List</h3>
            <p class="text-xs text-text-secondary leading-relaxed">
    ...
    <section class="py-8 px-4 sm:px-6 bg-bg-secondary border-y border-border">
      <div class="max-w-5xl mx-auto space-y-5">
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <span class="text-xs font-bold text-primary uppercase tracking-wider">Live Preview</span>
            <h2 class="font-serif font-bold text-xl sm:text-2xl text-text-primary mt-1">Your Current Foodie Top</h2>
    ...
    <!-- Bottom CTA Banner -->
    <section class="py-8 px-4 sm:px-6 max-w-3xl mx-auto text-center space-y-4">      <div class="p-5 sm:p-6 rounded-3xl bg-surface border border-border shadow-xl space-y-4 relative overflow-hidden">
        <div class="w-10 h-10 rounded-full bg-primary-subtle text-primary flex items-center justify-center mx-auto shadow-sm">
          <Utensils class="w-5 h-5" />
        </div>

        <div class="space-y-2 max-w-2xl mx-auto">
          <h2 class="font-serif font-bold text-xl sm:text-2xl text-text-primary">Ready to build your personal restaurant map?</h2>
        ...
        <div class="flex flex-wrap items-center justify-center gap-3">
          <button
            @click="ui.openModal('auth')"
            class="px-5 py-2.5 rounded-xl bg-primary hover:bg-primary-hover text-on-primary font-bold text-xs shadow-md transition-all active:scale-95 flex items-center gap-2">
            <span>Sign Up Free</span>
          </button>

          <router-link
            to="/mapa"
            class="px-4 py-2.5 rounded-xl bg-bg-secondary hover:bg-bg-tertiary border border-border text-text-primary font-bold text-xs transition-all active:scale-95 flex items-center gap-2">
    ...
    <!-- Footer -->
    <footer class="mt-auto py-3 border-t border-border bg-surface text-center text-xs text-text-tertiary font-medium">
